...
public class GraphDbUserModelFactory {
	...
	private void processXmlModel(Session session) throws Exception {
		...
		userModel.getAlgorithm().setNoDaysSinceMax(parser.getMeta("no_days_since_max"));
		userModel.getAlgorithm().setNoDaysSinceChosen(parser.getMeta("no_days_since_chosen"));
